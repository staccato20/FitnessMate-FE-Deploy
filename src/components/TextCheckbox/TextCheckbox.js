...
import * as TextCheck from "./StyledTextCheckbox";
...
function TextCheckbox(choicearticle) {
	return (
		<TextCheck.StyledTextCheckbox>
			<div className="TextCheckbox-layout">
				<span className="choice-article">{choicearticle}</span>
