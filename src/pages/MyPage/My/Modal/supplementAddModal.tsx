...
import { SearchBar, TextCheckbox } from "@components/index"
...
function SupplementAddModal({ onClose, routineId }) {
  ...
  const fetchData = async () => {
    try {
      ...
      const supplementResponse = await TokenApi.post(
        `/myfit/routines/supplement/search`,
        "",
        config,
      )
